...
def thread_name(start: str|None = None, end: str|None = 'thread-pool') -> Callable:
	"""
	Decorator that calls:
	- set_thread_name(start) before the decorated function, unless start is None;
	- set_thread_name(end) after the decorated function, unless end is None.
	"""
